...
class TemporalEncoder(nn.Module):
    def __init__(self, in_feat_dim=1024, embed_dims=[256, 384, 576, 864],
        ...
        # Stage 2
        self.Temporal_Merging_Block2 = Temporal_Merging_Block(kernel_size=3, stride=1, in_chans=embed_dims[0],
        ...
        # Stage 3
        self.Temporal_Merging_Block3 = Temporal_Merging_Block(kernel_size=3, stride=1, in_chans=embed_dims[1],
        ...
        # Stage 4
        self.Temporal_Merging_Block4 = Temporal_Merging_Block(kernel_size=3, stride=1, in_chans=embed_dims[2],
